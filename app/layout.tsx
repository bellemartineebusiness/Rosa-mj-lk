...
export const metadata: Metadata = {
  ...
  description:
    "Belle Martineé bygger AI-chattbottar för företag i alla branscher. Automatisera kundservice, bokning och leadinsamling dygnet runt. Från 1 499 kr/mån, gratis installation, igång samma dag.",
  keywords: [
    "AI chattbot",
    "chattbot företag",
    "AI kundservice",
  ...
  openGraph: {
    ...
    description:
      "AI-chattbottar som automatiserar kundservice, bokning och försäljning dygnet runt. Från 1 499 kr/mån, gratis installation, igång samma dag.",
    images: [
      {
